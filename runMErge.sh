...
then
	...
	cp -r $KLESS_PATH/klessydra-s1 $PULP_PATH/ips
	...
	# S1 patched files
	cp -f $KLESS_PATH/patched_files/s1_patched_files/cmake_configure.klessydra-s1.gcc.sh $PULP_PATH/sw
	cp -f $KLESS_PATH/patched_files/s1_patched_files/vcompile_klessydra-s1.csh $PULP_PATH/vsim/vcompile
